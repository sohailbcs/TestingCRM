...
namespace LegalAndGeneralConsultantCRM.Migrations
{
    ...
    [Migration("20240923223712_userid")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LegalAndGeneralConsultantCRM.Areas.Identity.Data.LegalAndGeneralConsultantCRMUser", b =>
                {
                    ...
                    b.Property<bool?>("Applicationprocessor")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LegalAndGeneralConsultantCRM.Models.Domain", b =>
                {
            ...
            modelBuilder.Entity("LegalAndGeneralConsultantCRM.Models.Frenchise", b =>
                {
                    b.Property<int>("FrenchiseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FrenchiseId"), 1L, 1);
                    ...
                    b.Property<string>("FrenchiseCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FrenchiseName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("FrenchiseId");
            ...
            modelBuilder.Entity("LegalAndGeneralConsultantCRM.Models.Leads.Lead", b =>
                {
                    ...
                    b.Property<string>("yearCompletion")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LegalAndGeneralConsultantCRM.Models.TargetTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LegalAndGeneralConsultantCRM.Models.Universiies.Course", b =>
                {
                    ...
                    b.Property<string>("DurationInYears")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LegalAndGeneralConsultantCRM.Models.Universiies.UniversityCourse", b =>
                {
                    ...
                    b.Property<string>("EaducationRequired")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EnglishProfiency")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Intake1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Intake2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Intake3")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LegalAndGeneralConsultantCRM.Models.Leads.Lead", b =>
                {
                    b.HasOne("LegalAndGeneralConsultantCRM.Models.Domain", "Domain")
                        .WithMany()
            ...
            modelBuilder.Entity("LegalAndGeneralConsultantCRM.Models.Universiies.UniversityCourse", b =>
                {
                    ...
                    b.HasOne("LegalAndGeneralConsultantCRM.Models.Leads.Lead", null)
                        .WithMany("UniversityCourse")
                        .HasForeignKey("LeadId");
